package in.co.sunrays.lbts.service;

import com.locationbasedtrackingsystem.activity.NotifyAlarmActivity;
...
public class ReminderAlarm extends BroadcastReceiver {
	...
	public void onReceive(Context context, Intent intent) {
		...
		Intent i = new Intent(context, NotifyAlarmActivity.class);
