...
import in.co.sunrays.lbts.activity.HomePageActivity;
...
public class LoginActivity extends BaseActivity implements LocationListener {
	...
	String outputData = "";
	String id = null, lat = null, longi = null;
		...
		signin.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (flag) {
					...
					loginTask
							.execute(new String[] { "http://www.nenosystems.co.in:8085/LBTSWeb/LoginCtl?login="
									+ loginVal
									+ "&password="
									+ pwdVal
									+ "&operation=Login" });
