...
import in.co.sunrays.lbts.service.GooglePlaces;
import in.co.sunrays.lbts.service.Place;
import in.co.sunrays.lbts.service.PlacesList;
					...
					if (status.equals("OK")) {
						...
						if (placesList.results != null) {
							...
							ListAdapter adapter = new SimpleAdapter(
									PlaceListActivity.this, placesListItems,
